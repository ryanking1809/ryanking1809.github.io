(function () {
				  ...
				  Math.floor(
						Math.log(
							e +
								Math.pow(
									10,
									1 + Math.floor(Math.log(e) / Math.LN10) - t
								)
						) / Math.LN10
				  )
				: 1)
	...
	function P(e) {
		...
		t[0] * n[1] < n[0] * t[1] &&
			((t[0] *= -1), (t[1] *= -1), (r *= -1), (i *= -1)),
			(this.rotate =
				(r ? Math.atan2(t[1], t[0]) : Math.atan2(-n[0], n[1])) * fs),
			(this.translate = [e.e, e.f]),
			(this.scale = [r, s]),
			(this.skew = s ? Math.atan2(i, s) * fs : 0);
	}
	function H(e, t) {
	...
	function V(e, t, n) {
		(e = $(e)), (t = $(t)), (n = $(n));
		var r = ot((0.4124564 * e + 0.3575761 * t + 0.1804375 * n) / ds),
			i = ot((0.2126729 * e + 0.7151522 * t + 0.072175 * n) / vs),
			s = ot((0.0193339 * e + 0.119192 * t + 0.9503041 * n) / ms);
	...
	function rt(e, t, n) {
		...
		return (
			...
			(s = st(s) * ms),
			R(
				ut(3.2404542 * i - 1.5371385 * r - 0.4985314 * s),
				ut(-0.969266 * i + 1.8760108 * r + 0.041556 * s),
				ut(0.0556434 * i - 0.2040259 * r + 1.0572252 * s)
			)
		);
	}
	function it(e, t, n) {
		return Y(
			(Math.atan2(n, t) / Math.PI) * 180,
			Math.sqrt(t * t + n * n),
			e
		);
	}
	...
	function kt() {
		...
		var r = Lt() - t;
		r > 24
			? (isFinite(r) && (clearTimeout(js), (js = setTimeout(kt, r))),
			  (Bs = 0))
			: ((Bs = 1), Fs(kt));
	}
	function Lt() {
	...
	function qt(e, t) {
		return d3.format(
			",." +
				Math.max(
					0,
					-Math.floor(Math.log(Ft(e, t)[2]) / Math.LN10 + 0.01)
				) +
				"f"
		);
	}
	...
	function cn(e, t) {
		return e.length < 4
			? un(e)
			: e[1] + dn(e.slice(1, e.length - 1), vn(e, t));
	}
	function hn(e, t) {
		return e.length < 3
			? un(e)
			: e[0] +
					dn(
						(e.push(e[0]), e),
						vn([e[e.length - 2]].concat(e, [e[1]]), t)
					);
	}
	function pn(e, t, n) {
				...
				function n() {
					...
					if (e.charCodeAt(t) === 34) {
						...
						return (
							o === 13
								? ((l = !0),
								  e.charCodeAt(n + 2) === 10 && s.lastIndex++)
								: o === 10 && (l = !0),
					...
					var a = s.exec(e);
					return a
						? ((l = a[0].charCodeAt(0) !== u),
						  e.substring(t, a.index))
	...
	function ei() {
		function e(e) {
			...
			return [
				Math.atan2(u, r) / ao,
				Math.atan2(a, Math.sqrt(r * r + u * u)) / ao,
			];
		}
		...
		var n = {
			...
			r = {
				...
				leftRegion: function (e) {
					return e.edge == null
						? n.bottomSite
						: e.edge.region[e.side];
				},
				rightRegion: function (e) {
					return e.edge == null
						? n.bottomSite
						: e.edge.region[ho[e.side]];
				},
			},
			i = {
				bisect: function (e, t) {
			...
			s = {
				...
				insert: function (e, t, n) {
					...
					for (var r = 0, i = s.list, o = i.length; r < o; r++) {
						...
						if (
							e.ystar > u.ystar ||
							(e.ystar == u.ystar && t.x > u.vertex.x)
						)
							continue;
						break;
					}
	...
	function ai(e, t, n, r, i, s) {
		if (!e(t, n, r, i, s)) {
			var o = (n + i) * 0.5,
				u = (r + s) * 0.5,
				a = t.nodes;
			a[0] && ai(e, a[0], n, r, o, u),
				a[1] && ai(e, a[1], o, r, i, u),
				a[2] && ai(e, a[2], n, u, o, s),
				a[3] && ai(e, a[3], o, u, i, s);
		}
	}
	function fi(e) {
		return { x: e[0], y: e[1] };
	...
	function gi(e, t, n) {
		...
		return r
			? ((e.m = Do.get(r[0].toLowerCase())), (n += r[0].length))
			: -1;
	}
	function yi(e, t, n) {
		Oo.lastIndex = 0;
		...
		return r
			? ((e.m = Mo.get(r[0].toLowerCase())), (n += r[0].length))
			: -1;
	}
	function bi(e, t, n) {
		...
		return (
			...
			(r.ticks = function (n, i) {
				...
				if (typeof n != "function") {
					...
					Math.log(u / Io[a - 1]) < Math.log(Io[a] / u) && --a,
						(n = t[a]),
						(i = n[1]),
						(n = n[0].range);
				}
	...
	(d3.functor = u),
		...
		(d3.zip = function () {
			...
			for (
				var e = -1, t = d3.min(arguments, l), n = new Array(t);
				++e < t;
	...
	(d3.bisectLeft = Yi.left),
		(d3.bisect = d3.bisectRight = Yi.right),
	...
	(d3.ns = {
		...
		qualify: function (e) {
			...
			return (
				...
				es.hasOwnProperty(n) ? { space: es[n], local: e } : e
			);
		},
	}),
	...
	(d3.interpolators = [
		...
		function (e, t) {
			return (
				(typeof t == "string"
					? hs.has(t) || /^(#|rgb\(|hsl\()/.test(t)
					: t instanceof U || t instanceof Q) &&
				d3.interpolateRgb(e, t)
			);
		},
		function (e, t) {
			return (
	...
	hs.forEach(function (e, t) {
		...
		(Q.prototype.brighter = function (e) {
			return (
				(e = Math.pow(0.7, arguments.length ? e : 1)),
				K(this.h, this.s, this.l / e)
			);
		}),
		(Q.prototype.darker = function (e) {
			return (
				(e = Math.pow(0.7, arguments.length ? e : 1)),
				K(this.h, this.s, e * this.l)
			);
		}),
		...
		(d3.hcl = function (e, t, n) {
			return arguments.length === 1
				? e instanceof Z
					...
					: e instanceof nt
					? it(e.l, e.a, e.b)
					: it((e = V((e = d3.rgb(e)).r, e.g, e.b)).l, e.a, e.b)
				: Y(+e, +t, +n);
		}),
		(Z.prototype.brighter = function (e) {
			return Y(
				this.h,
				this.c,
				Math.min(100, this.l + ps * (arguments.length ? e : 1))
			);
		}),
		(Z.prototype.darker = function (e) {
			return Y(
				this.h,
				this.c,
				Math.max(0, this.l - ps * (arguments.length ? e : 1))
			);
		}),
	...
	(d3.selection = function () {
		...
		(d3.selection.prototype = Ss),
		(Ss.select = function (e) {
			var t = [],
				n,
				r,
				i,
		...
		(Ss.selectAll = function (e) {
			...
			for (var i = -1, s = this.length; ++i < s; )
				for (var o = this[i], u = -1, a = o.length; ++u < a; )
					if ((r = o[u]))
						t.push((n = $i(e.call(r, r.__data__, u)))),
							(n.parentNode = r);
			return at(t);
		}),
			...
			if (arguments.length < 2) {
				if (typeof e == "string") {
					...
					return (
						(e = d3.ns.qualify(e)),
						e.local
							? n.getAttributeNS(e.space, e.local)
							: n.getAttribute(e)
					);
				}
		...
		(Ss.transition = function () {
			...
			for (var r = -1, i = this.length; ++r < i; ) {
				...
				for (var s = this[r], o = -1, u = s.length; ++o < u; )
					t.push(
						(n = s[o]) ? { node: n, delay: Ms, duration: _s } : null
					);
			}
	...
	var Ts = [];
	(d3.selection.enter = St),
		(d3.selection.enter.prototype = Ts),
		(Ts.append = Ss.append),
		(Ts.insert = Ss.insert),
		(Ts.empty = Ss.empty),
		(Ts.node = Ss.node),
		(Ts.select = function (e) {
			...
			for (var u = -1, a = this.length; ++u < a; ) {
				...
				for (var f = -1, l = s.length; ++f < l; )
					(o = s[f])
						? (n.push(
								(i[f] = r = e.call(s.parentNode, o.__data__, f))
						  ),
	...
	(Ns.call = Ss.call),
		...
		(Ns.filter = function (e) {
			...
			for (var s = 0, o = this.length; s < o; s++) {
				...
				for (var r = this[s], u = 0, a = r.length; u < a; u++)
					(i = r[u]) &&
						e.call(i.node, i.node.__data__, u) &&
						n.push(i);
			}
			return xt(t, this.id, this.time).ease(this.ease());
		}),
		...
		(Ns.text = function (e) {
			return this.tween("text", function (t, n) {
				this.textContent =
					typeof e == "function" ? e.call(this, t, n) : e;
			});
		}),
		(Ns.remove = function () {
	...
	(d3.timer = function (e, t, n) {
		...
		r || (Hs = { callback: e, then: n, delay: t, next: Hs }),
			...
			function e(s) {
				s.each(function () {
					...
					s
						...
						o &&
							((h = _t(o)),
							f.attr("x", h[0]).attr("width", h[1] - h[0]),
							n(s)),
						u &&
							((h = _t(u)),
			...
			function i() {
				...
				function h() {
					...
					N && ((e[0] += N[0]), (e[1] += N[1])),
						...
						s &&
							(t(y),
							g({ type: "brush", mode: S ? "move" : "resize" }));
				}
				function p(e, t, n) {
					var r = _t(t),
						i = r[0],
			...
			function t() {
				...
				function i() {
					u({ type: "dragend" }),
						h &&
							(M(),
							d3.event.target === a && p.on("click.drag", s, !0)),
						p
							.on(
								f ? "touchmove.drag-" + f : "mousemove.drag",
								null
							)
							.on(
								f ? "touchend.drag-" + f : "mouseup.drag",
								null
							);
				}
				function s() {
					...
					for (o = 0; o < n; ++o) {
						...
						if ((d = E * E + S * S))
							(d = (a * b[o] * ((d = Math.sqrt(d)) - y[o])) / d),
								...
								(S *= d),
								(c.x -=
									E * (v = l.weight / (c.weight + l.weight))),
								(c.y -= S * v),
								(l.x += E * (v = 1 - v)),
								(l.y += S * v);
					}
				...
				(n.drag = function () {
					o ||
						(o = d3.behavior
							...
							.on("drag", t)
							.on("dragend", Vn)),
						this.on("mouseover.force", $n)
							.on("mouseout.force", Jn)
							.call(o);
				}),
				d3.rebind(n, r, "on")
			);
	...
	d3.layout.stack = function () {
		...
		return (
			...
			(e.order = function (t) {
				return arguments.length
					? ((n = typeof t == "function" ? t : so.get(t) || tr), e)
					: n;
			}),
			(e.offset = function (t) {
				return arguments.length
					? ((r = typeof t == "function" ? t : oo.get(t) || nr), e)
					: r;
			}),
			(e.x = function (t) {
				return arguments.length ? ((o = t), e) : o;
	...
	(d3.layout.pack = function () {
			...
			function e(e, i) {
				...
				function u(e, t, r) {
					if (t) {
						...
						o &&
							!Ar(s) &&
							((s._tree.thread = o), (s._tree.mod += l - f)),
							i &&
								!Lr(u) &&
								((u._tree.thread = i),
								(u._tree.mod += a - c),
			...
			return (
				...
				(s.padding = function (e) {
					function t(t) {
						...
						return n == null
							? Fr(t)
							: Ir(t, typeof n == "number" ? [n, n, n, n] : n);
					}
					function n(t) {
						return Ir(t, e);
					}
		...
		(d3.csv = qr(",", "text/csv")),
		(d3.tsv = qr("	", "text/tab-separated-values")),
		(d3.geo = {});
	var ao = Math.PI / 180;
	(d3.geo.azimuthal = function () {
		...
		return (
			(e.invert = function (e) {
				var n = (e[0] - i[0]) / r,
					...
					h = Math.cos(l);
				return [
					(s + Math.atan2(n * c, f * u * h + o * a * c)) / ao,
					Math.asin(h * a - (f ? (o * c * u) / f : 0)) / ao,
				];
			}),
			(e.mode = function (n) {
				return arguments.length ? ((t = n + ""), e) : t;
		...
		(d3.geo.mercator = function () {
			function e(e) {
				var r = e[0] / 360,
					i =
						-(
							Math.log(Math.tan(Math.PI / 4 + (e[1] * ao) / 2)) /
							ao
						) / 360;
				return [
					t * r + n[0],
					t * Math.max(-0.5, Math.min(0.5, i)) + n[1],
				];
			}
			var t = 500,
				n = [480, 250];
			return (
				(e.invert = function (e) {
					...
					return [
						360 * r,
						(2 * Math.atan(Math.exp(-360 * i * ao))) / ao - 90,
					];
				}),
				(e.scale = function (n) {
					return arguments.length ? ((t = +n), e) : t;
		...
		(d3.geo.path = function () {
			function e(e, t) {
				typeof s == "function" && (o = Ur(s.apply(this, arguments))),
					f(e);
	...
	(d3.geo.circle = function () {
		...
		var f = Rr({
			...
			LineString: function (e) {
				...
				return (
					t.length && ((e = Object.create(e)), (e.coordinates = t), e)
				);
			},
			MultiLineString: function (e) {
			...
			Polygon: function (e) {
				...
				return (
					t[0].length &&
					((e = Object.create(e)), (e.coordinates = t), e)
				);
			},
			MultiPolygon: function (e) {
				var t = e.coordinates
			...
			GeometryCollection: function (e) {
				...
				return (
					t.length && ((e = Object.create(e)), (e.geometries = t), e)
				);
			},
		});
		return (
		...
		(d3.geo.greatArc = function () {
			...
			return (
				(e.distance = function () {
					return (
						typeof t == "function" &&
							o.source((n = t.apply(this, arguments))),
						typeof r == "function" &&
							o.target((i = r.apply(this, arguments))),
						o.distance()
					);
				}),
				(e.source = function (r) {
					return arguments.length
						? ((t = r),
						  typeof t != "function" && o.source((n = t)),
						  e)
						: t;
				}),
				(e.target = function (t) {
					return arguments.length
						? ((r = t),
						  typeof r != "function" && o.target((i = r)),
						  e)
						: r;
				}),
	...
	(d3.time.format.iso = Date.prototype.toISOString ? Di : Fo),
		(Di.parse = function (e) {
			var t = new Date(e);
			return isNaN(t) ? null : t;
		}),
		(Di.toString = Fo.toString),
		(d3.time.second = Pi(
			function (e) {
		...
		(d3.time.day = Pi(
			function (e) {
				var t = new po(1970, 0);
				return (
					t.setFullYear(e.getFullYear(), e.getMonth(), e.getDate()), t
				);
			},
			function (e, t) {
		...
		(d3.time.dayOfYear = function (e) {
			...
			return Math.floor(
				(e -
					t -
					(e.getTimezoneOffset() - t.getTimezoneOffset()) * 6e4) /
					864e5
			);
		}),
		vo.forEach(function (e, t) {
			...
			var n = (d3.time[e] = Pi(
				function (e) {
					return (
						(e = d3.time.day(e)).setDate(
							e.getDate() - ((e.getDay() + t) % 7)
						),
						e
					);
				},
				...
				function (e) {
					...
					return (
						Math.floor((d3.time.dayOfYear(e) + ((n + t) % 7)) / 7) -
						(n !== t)
					);
				}
			));
