!(function ($, wysi) {
	...
	var tpl = {
		"font-styles": function (locale, options) {
			...
			return (
				...
				"<i class='glyphicon glyphicon-font'></i>&nbsp;<span class='current-font'>" +
		...
		lists: function (locale, options) {
			...
			return (
				...
				"' tabindex='-1'><i class='glyphicon glyphicon-list'></i></a>" +
				"<a class='btn btn-default btn" +
				size +
				"' data-wysihtml5-command='insertOrderedList' title='" +
				locale.lists.ordered +
				"' tabindex='-1'><i class='glyphicon glyphicon-th-list'></i></a>" +
				"<a class='btn btn-default btn" +
				size +
				"' data-wysihtml5-command='Outdent' title='" +
				locale.lists.outdent +
				"' tabindex='-1'><i class='glyphicon glyphicon-indent-right'></i></a>" +
				"<a class='btn btn-default btn" +
				size +
				"' data-wysihtml5-command='Indent' title='" +
				locale.lists.indent +
				"' tabindex='-1'><i class='glyphicon glyphicon-indent-left'></i></a>" +
				"</div>" +
				"</li>"
			);
		},
		...
		link: function (locale, options) {
			...
			return (
				...
				locale.link.insert +
				"' tabindex='-1'><i class='glyphicon glyphicon-share'></i></a>" +
				"</li>"
			);
		},
		...
		image: function (locale, options) {
			...
			return (
				...
				locale.image.insert +
				"' tabindex='-1'><i class='glyphicon glyphicon-picture'></i></a>" +
				"</li>"
			);
		},
		...
		html: function (locale, options) {
			...
			return (
				...
				locale.html.edit +
				"' tabindex='-1'><i class='glyphicon glyphicon-pencil'></i></a>" +
				"</div>" +
				"</li>"
			);
		},
	...
	Wysihtml5.prototype = {
		...
		initInsertImage: function (toolbar) {
			var self = this;
			var insertImageModal = toolbar.find(
				".bootstrap-wysihtml5-insert-image-modal"
			);
			var urlInput = insertImageModal.find(
			...
			toolbar
				.find("a[data-wysihtml5-command=insertImage]")
				.click(function () {
					var activeButton = $(this).hasClass(
					...
					if (!activeButton) {
						...
						caretBookmark =
							self.editor.composer.selection.getBookmark();
		...
		initInsertLink: function (toolbar) {
			var self = this;
			var insertLinkModal = toolbar.find(
				".bootstrap-wysihtml5-insert-link-modal"
			);
			var urlInput = insertLinkModal.find(
				".bootstrap-wysihtml5-insert-link-url"
			);
			var targetInput = insertLinkModal.find(
	...
	var defaultOptions = ($.fn.wysihtml5.defaultOptions = {
		...
		stylesheets: [
			"<%= stylesheet_path('bootstrap-wysihtml5/wysiwyg-color.css') %>",
		], // (path_to_project/lib/css/wysiwyg-color.css)
		locale: "en",
	});
