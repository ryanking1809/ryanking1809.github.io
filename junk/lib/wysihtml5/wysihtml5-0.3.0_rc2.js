...
rangy.createModule("DomUtil", function (api, module) {
	...
	function isHtmlNamespace(node) {
		...
		return (
			...
			ns == "https://www.w3.org/1999/xhtml"
		);
	}
...
rangy.createModule("WrappedSelection", function (api, module) {
	...
	api.features.selectionSupportsMultipleRanges =
	...
	wysihtml5.commands.insertOrderedList = {
		exec: function (composer, command) {
			...
			if (composer.commands.support(command)) {
				...
				selectedNode = composer.selection.getSelectedNode();
				list = wysihtml5.dom.getParentElement(
					selectedNode,
					{ nodeName: ["UL", "OL"] },
					4
				);
			...
			_initAutoLinking: function () {
				var that = this,
					supportsDisablingOfAutoLinking =
						browser.canDisableAutoLinking(),
					supportsAutoLinking =
						browser.doesAutoLinkingInContentEditable();
	...
	/** @scope wysihtml5.views.Textarea.prototype */ {
		...
		hasPlaceholderSet: function () {
			var supportsPlaceholder =
					wysihtml5.browser.supportsPlaceholderAttributeOn(
						this.element
					),
				placeholderText =
	...
	wysihtml5.toolbar.Toolbar = Base.extend(
		/** @scope wysihtml5.toolbar.Toolbar.prototype */ {
			...
			execCommand: function (command, commandValue) {
				...
				var commandObj =
					this.commandMapping[command + ":" + commandValue];
