	...
	var bootstrapWizardCreate = function (element, options) {
		...
		this.next = function (e) {
			...
			if (
				...
				$settings.onNext($activeTab, $navigation, obj.nextIndex()) ===
					false
			) {
				return false;
			}
		...
		this.first = function (e) {
			if (
				...
				$settings.onFirst($activeTab, $navigation, obj.firstIndex()) ===
					false
			) {
				return false;
			}
		...
		this.last = function (e) {
			if (
				...
				$settings.onLast($activeTab, $navigation, obj.lastIndex()) ===
					false
			) {
				return false;
			}
			...
			$navigation
				.find("li:eq(" + obj.navigationLength() + ") a")
				.tab("show");
		};
		...
		this.nextTab = function () {
			return $navigation.find("li:eq(" + (obj.currentIndex() + 1) + ")")
				.length
				? $navigation.find("li:eq(" + (obj.currentIndex() + 1) + ")")
				: null;
		};
		this.previousTab = function () {
			...
			return $navigation.find(
				"li:eq(" + parseInt(obj.currentIndex() - 1) + ")"
			);
		};
		...
		this.remove = function (args) {
			var $index = args[0];
			var $removeTabPane =
				typeof args[1] != "undefined" ? args[1] : false;
		...
		$('a[data-toggle="tab"]', $navigation).on("click", function (e) {
			...
			var clickedIndex = $navigation
				.find("li")
				.index($(e.currentTarget).parent("li"));
			if (
				$settings.onTabClick &&
