...
(function (factory) {
	...
	$.widget("blueimp.fileupload", $.blueimp.fileupload, {
		options: {
			...
			add: function (e, data) {
				...
				$(this)
					...
					.done(function () {
						...
						data.files.valid = data.isValidated =
							that._validate(files);
						data.context = that
							._renderUpload(files)
							.data("data", data);
			...
			progressall: function (e, data) {
				var $this = $(this),
					...
					extendedProgressNode =
						globalProgressNode.find(".progress-extended");
		...
		_hasError: function (file) {
			...
			if (
				!(
					this.options.acceptFileTypes.test(file.type) ||
		...
		_initButtonBarEventHandlers: function () {
			var fileUploadButtonBar = this.element.find(
