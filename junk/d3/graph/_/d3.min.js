!(function () {
	...
	function I(n, t) {
		...
		return function (n) {
			var t = this,
				e = n.relatedTarget;
			(e && (e === t || 8 & e.compareDocumentPosition(t))) ||
				r.call(t, n);
		};
	}
	function Y() {
	...
	function ct(n, t, r) {
		return (
			isNaN(n) && (n = 0),
			isNaN(t) && (t = 0),
			st(r, Math.cos((n *= za)) * t, Math.sin(n) * t)
		);
	}
	function st(n, t, r) {
		return new lt(n, t, r);
	...
	function ht(n, t, r) {
		return n > 0
			? ot(Math.atan2(r, t) * La, Math.sqrt(t * t + r * r), n)
			: ot(0 / 0, 0 / 0, n);
	}
	function gt(n) {
	...
	function Lt() {
		var n = Tt(),
			t = qt() - n;
		t > 24
			? (isFinite(t) && (clearTimeout(Wa), (Wa = setTimeout(Lt, t))),
			  (Ja = 0))
			: ((Ja = 1), Ka(Lt));
	}
	function Tt() {
	...
	function Ot(n) {
			...
			function t(t) {
				for (var r, u, i, o = [], a = -1, c = 0; ++a < e; )
					37 === n.charCodeAt(a) &&
						...
						null != (u = ic[(r = n.charAt(++a))]) &&
							(r = n.charAt(++a)),
						(i = C[r]) &&
							(r = i(t, null == u ? ("e" === r ? " " : "0") : u)),
						o.push(r),
						(c = a + 1));
		...
		function e(n, t, r) {
			...
			return e
				? ((n.w = w.get(e[0].toLowerCase())), r + e[0].length)
				: -1;
		}
		function u(n, t, r) {
			M.lastIndex = 0;
			...
			return e
				? ((n.w = _.get(e[0].toLowerCase())), r + e[0].length)
				: -1;
		}
		function i(n, t, r) {
			E.lastIndex = 0;
			...
			return e
				? ((n.m = A.get(e[0].toLowerCase())), r + e[0].length)
				: -1;
		}
		function o(n, t, r) {
			S.lastIndex = 0;
			...
			return e
				? ((n.m = k.get(e[0].toLowerCase())), r + e[0].length)
				: -1;
		}
		function a(n, t, e) {
	...
	function Rr(n, t) {
		return (
			((n = n.x)[0] < 0 ? n[1] - Aa - Ca : Aa - n[1]) -
			((t = t.x)[0] < 0 ? t[1] - Aa - Ca : Aa - t[1])
		);
	}
	function Dr(n, t) {
		var r = n[0],
		...
		return function (a) {
			function c(n) {
				for (var t = 0, r = d.length, e = n[1], u = 0; r > u; ++u)
					for (
						var i, o = 1, a = d[u], c = a.length, s = a[0];
						c > o;
						++o
					)
						(i = a[o]),
		...
		function u(t, r, e, a, c, s, l, f, h, g, p, v, d, m) {
			...
			if (M > 4 * i && d--) {
				var _ = a + g,
					...
					T = x * z - y * L;
				((T * T) / M > i ||
					ca((y * z + x * L) / M - 0.5) > 0.3 ||
					o > a * g + c * p + s * v) &&
					(u(t, r, e, a, c, s, C, N, E, (_ /= S), (b /= S), w, d, m),
					m.point(C, N),
	...
	function ie(n) {
		...
		return (
			...
			(t.clipAngle = function (n) {
				return arguments.length
					? ((M = null == n ? ((b = n), Ac) : Hr((b = +n) * za)), u())
					: b;
			}),
			(t.clipExtent = function (n) {
				return arguments.length
					? ((w = n),
					  (_ = n ? Or(n[0][0], n[0][1], n[1][0], n[1][1]) : At),
					  u())
					: w;
			}),
			(t.scale = function (n) {
	...
	function ge(n, t) {
		...
		return function (u, i, o, a) {
			...
			for (var s, l = u; o > 0 ? l > i : i > l; l -= c)
				a.point(
					(s = Mr([r, -e * Math.cos(l), -e * Math.sin(l)]))[0],
					s[1]
				);
		};
	}
	...
	function Me() {
		function n(n, u) {
			...
			(jc += Math.atan2(
				Math.sqrt(
					(a = o * Math.sin(a)) * a + (a = e * i - r * o * c) * a
				),
				r * i + e * o * c
			)),
				(t = n),
	...
	function Ue(n) {
		...
		for (
			var c = i;
			c.circle && ca(r - c.circle.x) < Ca && ca(e - c.circle.cy) < Ca;
		...
		for (
			var s = o;
			s.circle && ca(r - s.circle.x) < Ca && ca(e - s.circle.cy) < Ca;
		...
		(c = a[0]),
			(s = a[f - 1]),
			(s.edge = We(c.site, s.site, null, u)),
			Ve(c),
			Ve(s);
	}
	function je(n) {
		...
		if ((Bc.insert(t, c), t || r)) {
			if (t === r)
				return (
					...
					(r = De(t.site)),
					Bc.insert(c, r),
					(c.edge = r.edge = We(t.site, c.site)),
					Ve(t),
					Ve(r),
					void 0
				);
			...
			Ke(r.edge, s, p, M),
				(c.edge = We(s, n, null, M)),
				(r.edge = We(n, p, null, M)),
				Ve(t),
				Ve(r);
		}
	}
	...
	function Xe(n) {
		for (
			...
			(t = r[u]),
				(!Be(t, n) ||
					!e(t) ||
					(ca(t.a.x - t.b.x) < Ca && ca(t.a.y - t.b.y) < Ca)) &&
	...
	function We(n, t, r, e) {
		...
		return (
			...
			r && Ke(u, n, t, r),
			e && Ke(u, t, n, e),
			Xc[n.i].edges.push(new Qe(u, n, t)),
			Xc[t.i].edges.push(new Qe(u, t, n)),
			u
		);
	}
	function Ge(n, t, r) {
	...
	function iu(n, t) {
		var r,
			...
			i = n.sort(ou).pop();
		for (
			$c = [], Xc = new Array(n.length), Bc = new nu(), Wc = new nu();
			;

		)
			if (
				((u = Jc), i && (!u || i.y < u.y || (i.y === u.y && i.x < u.x)))
			)
				(i.x !== r || i.y !== e) &&
					((Xc[i.i] = new Oe(i)), je(i), (r = i.x), (e = i.y)),
					(i = n.pop());
			else {
				if (!u) break;
				Ue(u.arc);
	...
	function fu(n, t, r, e, u, i) {
		if (!n(t, r, e, u, i)) {
			var o = 0.5 * (r + u),
				a = 0.5 * (e + i),
				c = t.nodes;
			c[0] && fu(n, c[0], r, e, o, a),
				c[1] && fu(n, c[1], o, e, u, a),
				c[2] && fu(n, c[2], r, a, o, i),
	...
	function du(n, t) {
		for (
			var r, e = Bo.interpolators.length;
			--e >= 0 && !(r = Bo.interpolators[e](n, t));
	...
	function Cu(n, t) {
		...
		return (
			...
			arguments.length
				? (r = (t / Ea) * Math.asin(1 / n))
				: ((n = 1), (r = t / 4)),
			function (e) {
				return (
					1 + n * Math.pow(2, -10 * e) * Math.sin(((e - r) * Ea) / t)
				);
			}
		);
	}
	...
	function Du(n) {
		...
		t[0] * r[1] < r[0] * t[1] &&
			((t[0] *= -1), (t[1] *= -1), (e *= -1), (u *= -1)),
			(this.rotate =
				(e ? Math.atan2(t[1], t[0]) : Math.atan2(-r[0], r[1])) * La),
	...
	function Zu(n, t) {
		if (n === t) return n;
		for (
			var r = Yu(n), e = Yu(t), u = r.pop(), i = e.pop(), o = null;
			u === i;
	...
	function Wu(n, t) {
		return (
			Bo.rebind(n, t, "sort", "children", "value"),
			(n.nodes = n),
			(n.links = ri),
			n
		);
	...
	function yi(n) {
		...
		if ((r = n.children) && (s = r.length)) {
			...
			if (
				...
				(e.y = 0),
				t(e),
				s > 1 && ((u = r[1]), (u.x = u.r), (u.y = 0), t(u), s > 2))
			)
				for (
					i = r[2],
						bi(e, u, i),
	...
	function _i(n, t, r, e) {
		...
		if (((n.x = t += e * n.x), (n.y = r += e * n.y), (n.r *= e), u))
			for (var i = -1, o = u.length; ++i < o; ) _i(u[i], t, r, e);
	}
	function bi(n, t, r) {
		var e = n.r + r.r,
			u = t.x - n.x,
	...
	function Bi(n, t) {
		var r = Xi(t[2]);
		return n in gs
			? Math.abs(r - Xi(Math.max(ca(t[0]), ca(t[1])))) + +("e" !== n)
			: r - 2 * ("%" === n);
	}
	function Ji(n, t, r, e) {
		function u(n) {
			return (
				(r ? Math.log(0 > n ? 0 : n) : -Math.log(n > 0 ? 0 : -n)) /
				Math.log(t)
			);
		}
		function i(n) {
		...
		return (
			...
			(o.tickFormat = function (n, t) {
				...
				arguments.length < 2
					? (t = ps)
					: "function" != typeof t && (t = Bo.format(t));
				var e,
	...
	function Wi(n, t, r) {
		...
		return (
			...
			(e.domain = function (t) {
				return arguments.length
					? (n.domain((r = t.map(Number)).map(u)), e)
					: r;
			}),
			(e.ticks = function (n) {
				return Vi(r, n);
	...
	function Ki(n, t) {
		function r(r) {
			return i[
				((u.get(r) || ("range" === t.t ? u.set(r, n.push(r)) : 0 / 0)) -
					1) %
					i.length
			];
		}
		...
		return (
			...
			(r.rangePoints = function (u, o) {
				...
				return (
					(i = e(n.length < 2 ? (c + s) / 2 : c + (l * o) / 2, l)),
					(a = 0),
	...
	function lo(n) {
		for (
			var t = 0, r = n.length, e = n[0], u = [e[0], ",", e[1]];
			++t < r;
	...
	function go(n, t) {
		return n.length < 4
			? co(n)
			: n[1] + mo(n.slice(1, n.length - 1), yo(n, t));
	}
	function po(n, t) {
		return n.length < 3
			? co(n)
			: n[0] +
					mo(
						(n.push(n[0]), n),
						yo([n[n.length - 2]].concat(n, [n[1]]), t)
					);
	}
	function vo(n, t) {
	...
	function _o(n) {
		for (
			var t, r, e = -1, u = n.length, i = u + 4, o = [], a = [];
			++e < 4;

		)
			(r = n[e % u]), o.push(r[0]), a.push(r[1]);
		for (t = [wo(ks, o), ",", wo(ks, a)], --e; ++e < i; )
			(r = n[e % u]),
				o.shift(),
				o.push(r[0]),
				a.shift(),
	...
	function Ao(n) {
		for (
			var t, r, e, u, i = [], o = Eo(n), a = -1, c = n.length - 1;
			++a < c;
	...
	function jo(n, t, r, e) {
		...
		return P(
			...
			"function" == typeof r
				? function (n, i, o) {
						n.__transition__[u].tween.set(
							t,
							e(r.call(n, n.__data__, i, o))
						);
				  }
				: ((r = e(r)),
				  function (n) {
	...
	function Fo(n, t, r, e) {
		var u =
				n.__transition__ ||
				(n.__transition__ = { active: 0, count: 0 }),
			i = u[r];
		if (!i) {
			var a = e.time;
			(i = u[r] =
	...
	function Xo(n) {
		...
		return (
			t.selectNode(Go.body), t.createContextualFragment(n.responseText)
		);
	}
	...
	(Bo.ascending = n),
		...
		(Bo.median = function (r, e) {
			return (
				...
				(r = r.filter(t)),
				r.length ? Bo.quantile(r.sort(n), 0.5) : void 0
			);
		});
	var aa = r(n);
	(Bo.bisectLeft = aa.left),
		...
		(Bo.zip = function () {
			...
			for (
				var n = -1, t = Bo.min(arguments, e), r = new Array(t);
				++n < t;
	...
	(Bo.range = function (n, t, r) {
		...
		i(o, {
			...
			forEach: function (n) {
				for (var t in this)
					t.charCodeAt(0) === la &&
						n.call(this, t.substring(1), this[t]);
			},
		});
	var sa = "\x00",
		la = sa.charCodeAt(0);
	...
	(Bo.dispatch = function () {
		...
		(d.prototype.on = function (n, t) {
			var r = n.indexOf("."),
				e = "";
			if (
				(r >= 0 && ((e = n.substring(r + 1)), (n = n.substring(0, r))),
				n)
			)
		...
		(ya.selectAll = function (n) {
			...
			for (var u = -1, i = this.length; ++u < i; )
				for (var o = this[u], a = -1, c = o.length; ++a < c; )
					(r = o[a]) &&
						(e.push((t = Wo(n.call(r, r.__data__, a, u)))),
						(t.parentNode = r));
			return _(e);
		});
	var xa = {
	...
	(Bo.ns = {
		...
		qualify: function (n) {
			...
			return (
				...
				xa.hasOwnProperty(r) ? { space: xa[r], local: n } : n
			);
		},
	}),
	...
	(Bo.selection.enter = U),
		...
		(Ma.select = function (n) {
			for (
				var t, r, e, u, i, o = [], a = -1, c = this.length;
				++a < c;
				...
				for (var s = -1, l = u.length; ++s < l; )
					(i = u[s])
						? (t.push(
								(e[s] = r =
									n.call(u.parentNode, i.__data__, s, a))
						  ),
	...
	(Bo.interpolateZoom = function (n, t) {
		...
		(Bo.behavior.zoom = function () {
			...
			function s() {
				...
				function r() {
					f.on(C, Qo === e ? h : null).on(N, null),
						p(l && Bo.event.target === i),
						c(s);
				}
				var e = this,
					i = Bo.event.target,
			...
			function l() {
				...
				function r() {
					...
					for (
						var r = Bo.event.changedTouches, o = 0, c = r.length;
						c > o;
						++o
					)
				...
				function i() {
					for (
						var n, t, r, i, o = Bo.touches(g), c = 0, s = o.length;
						s > c;
						++c, i = null
					)
	...
	var Da,
		...
		Ua =
			"onwheel" in Go
				? ((Da = function () {
						return (
							-Bo.event.deltaY * (Bo.event.deltaMode ? 120 : 1)
						);
				  }),
				  "wheel")
				: "onmousewheel" in Go
		...
		(Bo.hcl = function (n, t, r) {
			return 1 === arguments.length
				? n instanceof at
					...
					: n instanceof lt
					? ht(n.l, n.a, n.b)
					: ht((n = wt((n = Bo.rgb(n)).r, n.g, n.b)).l, n.a, n.b)
				: ot(+n, +t, +r);
		});
	...
	(Ha.brighter = function (n) {
		return ot(
			this.h,
			this.c,
			Math.min(100, this.l + Fa * (arguments.length ? n : 1))
		);
	}),
		(Ha.darker = function (n) {
			return ot(
				this.h,
				this.c,
				Math.max(0, this.l - Fa * (arguments.length ? n : 1))
			);
		}),
		(Ha.rgb = function () {
	...
	$a.forEach(function (n, t) {
		...
		(Bo.touch = function (n, t, r) {
			if (
				(arguments.length < 3 && ((r = t), (t = x().changedTouches)), t)
			)
	...
	(Bo.timer = function (n, t, r) {
		...
		Ba ? (Ba.n = i) : (Xa = i),
			(Ba = i),
			Ja || ((Wa = clearTimeout(Wa)), (Ja = 1), Ka(Lt));
	}),
	...
	var nc =
		...
		tc = Bo.map({
			...
			r: function (n, t) {
				return (n = Bo.round(n, Rt(n, t))).toFixed(
		...
		[
			...
			var r = (rc[n] = Ht(
				...
				function (n) {
					...
					return (
						Math.floor((rc.dayOfYear(n) + ((r + t) % 7)) / 7) -
						(r !== t)
					);
				}
			));
	...
	var hc,
		...
		pc = {
			...
			polygonEnd: function () {
				var n = 2 * gc;
				(hc += 0 > n ? 4 * ka + n : n),
					(pc.lineStart = pc.lineEnd = pc.point = v);
			},
		};
	(Bo.geo.bounds = (function () {
		...
		(Bo.geo.centroid = function (n) {
			...
			return Na > u &&
				...
				(r = _c),
				(e = bc),
				Ca > dc && ((t = mc), (r = yc), (e = xc)),
				(u = t * t + r * r + e * e),
				Na > u)
				? [0 / 0, 0 / 0]
				: [Math.atan2(r, t) * La, G(e / Math.sqrt(u)) * La];
		});
	var vc,
		dc,
		mc,
	...
	(Bo.geo.path = function () {
		...
		return (
			...
			(n.projection = function (n) {
				return arguments.length
					? ((u = (r = n) ? n.stream || te(n) : At), t())
					: r;
			}),
			(n.context = function (n) {
				return arguments.length
					? ((i = null == (e = n) ? new Xr() : new Qr(n)),
		...
		(Bo.geo.rotation = function (n) {
			function t(t) {
				return (
					(t = n(t[0] * za, t[1] * za)), (t[0] *= La), (t[1] *= La), t
				);
			}
			return (
				(n = se(
		...
		(Bo.geo.distance = function (n, t) {
			var r,
				...
				f = Math.cos(i);
			return Math.atan2(
				Math.sqrt((r = f * o) * r + (r = s * l - c * f * a) * r),
				c * l + s * f * a
			);
		}),
		...
		(Vc.clip = function (n) {
			for (
				...
				for (
					...
					(o = t[r]),
						Le(o, l, u)
							? (Le(i, l, u) || n.push(Te(i, o, l, u)), n.push(o))
							: Le(i, l, u) && n.push(Te(i, o, l, u)),
						(i = o);
				a && n.push(n[0]), (l = u);
			}
			return n;
	...
	(Bo.ease = function (n) {
		...
		return (
			(r = es.get(r) || rs),
			(e = us.get(e) || At),
			yu(e(r.apply(null, Jo.call(arguments, 1))))
		);
	}),
				...
				(a.tick = function () {
					...
					for (r = 0; b > r; ++r)
						(a = y[r]),
							...
							(p = x * x + M * M) &&
								((p =
									(e * i[r] * ((p = Math.sqrt(p)) - u[r])) /
									p),
								(x *= p),
								(M *= p),
								(h.x -=
									x * (d = f.weight / (h.weight + f.weight))),
								(h.y -= M * d),
								(f.x += x * (d = 1 - d)),
								(f.y += M * d));
					if (
						(d = e * v) &&
						((x = s[0] / 2), (M = s[1] / 2), (r = -1), d)
					)
						for (; ++r < _; )
							(a = m[r]),
								(a.x += (x - a.x) * d),
					...
					if (g)
						for (
							Ju((t = Bo.geom.quadtree(m)), e, o), r = -1;
							++r < _;
	...
	(Bo.layout.hierarchy = function () {
		function n(u) {
			...
			for (u.depth = 0; null != (i = o.pop()); )
				if (
					(a.push(i), (s = r.call(n, i, i.depth)) && (c = s.length))
				) {
					for (var c, s, l; --c >= 0; )
						o.push((l = s[c])),
							(l.parent = i),
					...
					e && (i.value = +e.call(n, i, i.depth) || 0),
						delete i.children;
			return (
				Ku(u, function (n) {
					var r, u;
					t && (r = n.children) && r.sort(t),
						e && (u = n.parent) && (u.value += n.value);
				}),
				a
			);
		}
				...
				return (
					e &&
						...
						Ku(t, function (t) {
							var r;
							t.children ||
								(t.value = +e.call(n, t, t.depth) || 0),
								(r = t.parent) && (r.value += t.value);
						})),
					t
				);
			}),
	...
	Bo.layout.stack = function () {
		function n(a, c) {
			...
			for (g = 0; m > g; ++g)
				for (
					u.call(n, s[0][g], (p = v[g]), l[0][g][1]), h = 1;
					d > h;
					++h
				)
		...
		return (
			...
			(n.order = function (t) {
				return arguments.length
					? ((r = "function" == typeof t ? t : ls.get(t) || oi), n)
					: r;
			}),
			(n.offset = function (t) {
				return arguments.length
					? ((e = "function" == typeof t ? t : fs.get(t) || ai), n)
					: e;
			}),
			(n.x = function (t) {
		...
		(Bo.layout.pack = function () {
			function n(n, i) {
				...
				if (
					...
					var f =
						(e * (t ? 1 : Math.max((2 * a.r) / c, (2 * a.r) / s))) /
						2;
					Ku(a, function (n) {
						n.r += f;
					}),
			...
			return (
				...
				(n.radius = function (r) {
					return arguments.length
						? ((t = null == r || "function" == typeof r ? r : +r),
						  n)
						: t;
				}),
				...
				if (t) {
					for (
						...
						(c = Si(c)),
							(i = ki(i)),
							(i.a = n),
							(e = o.z + f - u.z - s + a(o._, u._)),
							e > 0 &&
								(Ei(Ci(o, n, r), n, e), (s += e), (l += e)),
							(f += o.m),
							(s += u.m),
							(h += c.m),
							(l += i.m);
					o && !ki(i) && ((i.t = o), (i.m += f - l)),
						u && !Si(c) && ((c.t = u), (c.m += s - h), (r = n));
				}
				return r;
			}
			function i(n) {
					...
					var o,
						...
						v =
							"slice" === g
								...
								: Math.min(s.dx, s.dy);
					for (
						n(h, (s.dx * s.dy) / r.value), l.area = 0;
						(c = h.length) > 0;

					)
						l.push((o = h[c - 1])),
							(l.area += o.area),
							"squarify" !== g || (a = e(l, v)) <= p
								? (h.pop(), (p = a))
								: ((l.area -= l.pop().area),
								  u(l, v, s, !1),
								  ...
								  (l.length = l.area = 0),
								  (p = 1 / 0));
					l.length && (u(l, v, s, !0), (l.length = l.area = 0)),
						i.forEach(t);
				}
			}
			function r(t) {
			...
			return (
				...
				(i.padding = function (n) {
					function t(t) {
						...
						return null == r
							? qi(t)
							: Ri(t, "number" == typeof r ? [r, r, r, r] : r);
					}
					function r(t) {
						return Ri(t, n);
					}
		...
		(Ls.select = function (n) {
			...
			for (var o = -1, a = this.length; ++o < a; ) {
				...
				for (var c = this[o], s = -1, l = c.length; ++s < l; )
					(e = c[s]) && (r = n.call(e, e.__data__, s, o))
						? ("__data__" in e && (r.__data__ = e.__data__),
						  Fo(r, s, u, e.__transition__[u]),
						  t.push(r))
						: t.push(null);
			}
			return Uo(i, u);
		...
		(Ls.styleTween = function (n, t, r) {
			function e(e, u) {
				var i = t.call(
					...
					e,
					u,
					Qo.getComputedStyle(this, null).getPropertyValue(n)
				);
				return (
					i &&
					function (t) {
			...
			return (
				arguments.length < 3 && (r = ""), this.tween("style." + n, e)
			);
		}),
		(Ls.text = function (n) {
		...
		(Ls.delay = function (n) {
			...
			return arguments.length < 1
				...
				: P(
						...
						"function" == typeof n
							? function (r, e, u) {
									r.__transition__[t].delay = +n.call(
										r,
										r.__data__,
										e,
										u
		...
		(Ls.each = function (n, t) {
			...
			if (arguments.length < 2) {
				...
				P(this, function (e) {
					...
					(u.event || (u.event = Bo.dispatch("start", "end"))).on(
						n,
						t
					);
				});
	...
	Bo.svg.brush = function () {
		...
		function u() {
			...
			function d(n, t, r) {
				...
				return (
					...
					C
						? (u = (e += p) + d)
						: (x && (p = Math.max(c, Math.min(s, 2 * x[r] - e))),
						  e > p ? ((u = e), (e = p)) : (u = p)),
					v[0] != e || v[1] != u
						? (r ? (o = null) : (i = null),
						  (v[0] = e),
		...
		return (
			...
			(n.clear = function () {
				return (
					n.empty() || ((l = [0, 0]), (f = [0, 0]), (i = o = null)), n
				);
			}),
			(n.empty = function () {
